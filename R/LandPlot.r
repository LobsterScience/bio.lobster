...
LandPlot <- function(land,usr,lrp,lfa,out.dir='bio.lobster') {
			...
			dir.create( fd, recursive = TRUE, showWarnings = FALSE )
					...
					labs = 'Wt'
						...
						plot(land$YR,land[,2],xlab='Year',ylab='Landings (t)',type='b',lwd=2,pch=16,main=paste('LFA',lfa,sep=' '),ylim=ylims)
