...
load.environment <- function(){
   p = list()
    ...
    p$libs = RLibrary( c( 'rgdal',"devtools","roxygen2","geosphere", "chron", "lubridate", "parallel","sp","PBSmapping","RColorBrewer" ,'lattice','MASS','doBy','bio.lobster','SpatialHub','bio.polygons','bio.utilities','bio.lobster','bio.survey','bio.spacetime','lbm')  )
