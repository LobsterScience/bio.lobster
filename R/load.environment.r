...
#    p$libs = RLibrary( c('RODBC', 'rgdal',"devtools","roxygen2","geosphere", "chron","fields",  "parallel","sp","spatstat","PBSmapping","RColorBrewer" ,'lattice','MASS','doBy','bio.lobster','bio.utilities','bio.lobster','bio.survey',"lubridate","SpatialHub"))
...
#load_all('~/git/bio.spacetime')
      ...
      p = bio.lobster::spatial_parameters(p=p)
