...
load.environment <- function(){
   p = list()
    ...
    p$libs = RLibrary( c( 'rgdal',"devtools","roxygen2","geosphere", "chron","fields",  "parallel","sp","spatstat","PBSmapping","RColorBrewer" ,'lattice','MASS','doBy','bio.lobster','bio.polygons','bio.utilities','bio.lobster','bio.survey','bio.spacetime',"lubridate","SpatialHub"))#,'lbm','raster')  )
