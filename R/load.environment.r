...
load.environment <- function(){
   p = list()
    ...
    p$libs = RLibrary( c( 'rgdal',"geosphere", "chron", "lubridate", "parallel","sp","PBSmapping","RColorBrewer" ,'lattice','MASS','doBy','bio.polygons','bio.groundfish','bio.utilities','bio.survey','bio.spacetime')  )
