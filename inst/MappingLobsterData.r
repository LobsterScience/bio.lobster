...
catchgrids<-lobGridPlot(subset(logsInSeason,LFA %in% c('33','34')&SYEAR==2013 & CPUE<10 & WOS %in% c(19:23),c("LFA","GRID_NUM","CPUE")),lvls = c(0.1,0.25,0.5,0.75,1,1.5,2.5,3.8),FUN=mean,border=NA)
...
ContLegend("bottomright",lvls=catchgrids$lvls,Cont.data=catchgrids,title="CPUE (kg/TH)",inset=0.02,cex=0.8,bg='white')
