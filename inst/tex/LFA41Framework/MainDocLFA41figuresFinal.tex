...
%survey bubbles
        \begin{figure}
        \centering
        \pdftooltip{\subfloat{\includegraphics[clip,trim={0 2.1cm 0.3cm 2.1cm},width=0.37\textwidth]{\e surveyBubblesDFOSummer\D 1970\D 1974.pdf}}
        \subfloat{\includegraphics[clip,trim={0 2.1cm 0.3cm 2.1cm},width=0.37\textwidth]{\e surveyBubblesDFOSummer\D 1975\D 1979.pdf}}
        \subfloat{\includegraphics[clip,trim={0 2.1cm 0.3cm 2.1cm},width=0.37\textwidth]{\e surveyBubblesDFOSummer\D 1980\D 1984.pdf}}}{Figure 5}\\
...
\begin{landscape}
        ...
        \begin{figure}
        \centering
        \pdftooltip{\subfloat{\includegraphics[clip,trim={0 2.1cm 0.3cm 2.1cm},width=0.47\textwidth]{\e surveyBubblesDFOGeorges\D 1987\D 1994.pdf}}}{Figure 7}
...
\end{landscape}
        ...
        \begin{figure}
        \centering
                \pdftooltip{\subfloat{\includegraphics[clip,trim={0 2.1cm 0.3cm 2.1cm},width=0.37\textwidth]{\e surveyBubblesNEFSCSpring\D 1969\D 1974.pdf}}
        \subfloat{\includegraphics[clip,trim={0 2.1cm 0.3cm 2.1cm},width=0.37\textwidth]{\e surveyBubblesNEFSCSpring\D 1975\D 1979.pdf}}
        \subfloat{\includegraphics[clip,trim={0 2.1cm 0.3cm 2.1cm},width=0.37\textwidth]{\e surveyBubblesNEFSCSpring\D 1980\D 1984.pdf}}}{Figure 9}\\
        ...
        \begin{figure}
        \centering
                \pdftooltip{\subfloat{\includegraphics[clip,trim={0 2.1cm 0.3cm 2.1cm},width=0.37\textwidth]{\e surveyBubblesNEFSCFall\D 1969\D 1974.pdf}}
        \subfloat{\includegraphics[clip,trim={0 2.1cm 0.3cm 2.1cm},width=0.37\textwidth]{\e surveyBubblesNEFSCFall\D 1975\D 1979.pdf}}
        \subfloat{\includegraphics[clip,trim={0 2.1cm 0.3cm 2.1cm},width=0.37\textwidth]{\e surveyBubblesNEFSCFall\D 1980\D 1984.pdf}}}{Figure 10}\\
...
%%%%Incidental catch
        ...
        \begin{figure}
        \centering
                \pdftooltip{\includegraphics[width=0.8\textwidth]{\e LFA41ObserverCoverageNTrips2016.png}}{Figure 11}
...
\begin{figure}
        \centering
                \pdftooltip{\includegraphics[width=0.8\textwidth]{\e LFA41ObserverCoveragebyWeightLanded\D 2016.png}}{Figure 12}
...
\begin{landscape}
        \begin{figure}
        \centering
                \pdftooltip{\subfloat{\includegraphics[width=0.45\textwidth]{\e LFA41bycatchest1yr.png}}
        \subfloat{\includegraphics[width=0.5\textwidth]{\e LFA41bycatchest3yr.png}}}{Figure 13}\\
...
%survey efficiency
        ...
        \begin{figure}
        \centering
                \pdftooltip{\subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41DFObase.pdf}}
        \subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41DFOrestratified.pdf}}}{Figure 14}\\
        ...
        \begin{figure}
        \centering
                \pdftooltip{\subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41NEFSCspringbase.pdf}}
        \subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41NEFSCspringrestratified.pdf}}}{Figure 15}\\
        ...
        \begin{figure}
        \centering
                \pdftooltip{\subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41NEFSCfallbase.pdf}}
        \subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41NEFSCfalrestratified.pdf}}}{Figure 16}\\
...
\subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41NEFSCSpringrestratifiednumbersNOY.png}}}{Figure 17}\\
...
\begin{figure}
\centering
   \pdftooltip{ \includegraphics[width=.58\textwidth]{\e pezzackRVDFObasenumbers.png} 
    \includegraphics[width=.58\textwidth]{\e pezzacksummerstratamap.pdf}}{Figure 18}
...
\begin{figure}
\centering
    \pdftooltip{ \includegraphics[width=.58\textwidth]{\e pezzacklfa41georgesnumbers.png} 
    \includegraphics[width=.58\textwidth]{\e pezzackgeorgesmap41.pdf}}{Figure 19}
...
\begin{figure}
\centering
\pdftooltip{\subfloat{\includegraphics[width=0.5\textwidth]{\e NOYlfa41DFOrestratifiednumbersrecruits.png}}
\subfloat{\includegraphics[width=0.5\textwidth]{\e NOYlfa41NEFSCSpringrestratifiednumbersrecruits.png}}}{Figure 20}\\
...
\begin{figure}
\centering
\pdftooltip{\subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41DFOrestratifiednumberslargefemale.png}}
\subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41NEFSCSpringrestratifiednumberslargefemale.png}}}{Figure 21}\\
...
\begin{figure}
\centering
 \pdftooltip{   \includegraphics[width=.58\textwidth]{\e pezzacklfa41largefemale.png} 
    \includegraphics[width=.58\textwidth]{\e pezzack480481map.pdf} }{Figure 22}
...
\begin{figure}
\centering
 \pdftooltip{\includegraphics[width=.58\textwidth]{\e largefemalepezzackgeorges.png}}{Figure 23} 
...
\subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41NEFSCSpringrestratifiedDWAO.png}}}{Figure 24}\\
...
\subfloat{\includegraphics[width=0.5\textwidth]{\e lfa41NEFSCSpringrestratifiedgini.png}}}{Figure 25}\\
...
\begin{figure}
\centering
\pdftooltip{\subfloat{\includegraphics[width=0.5\textwidth]{\e maturesexLFA41polygonSummerRV.png}}
\subfloat{\includegraphics[width=0.5\textwidth]{\e maturesexLFA41NEFSCspringrestratified.png}}}{Figure 26}\\
...
\begin{figure}
\centering
\pdftooltip{\subfloat{\includegraphics[width=0.5\textwidth]{\e immaturesexLFA41polygonSummerRV.png}}
\subfloat{\includegraphics[width=0.5\textwidth]{\e immaturesexLFA41NEFSCspringrestratified.png}}}{Figure 27}\\
...
\subfloat{\includegraphics[width=0.5\textwidth]{\e medianL\D LengthFrequenciesLFA41NEFSCspringrestratified.png}}}{Figure 28}\\
...
\subfloat{\includegraphics[width=0.5\textwidth]{\e max95\D LengthFrequenciesLFA41NEFSCspringrestratified.pdf}}}{Figure 29}\\
...
\subfloat{\includegraphics[clip,trim={0 0.7cm 0cm 1.56cm},width=0.43\textwidth]{\e medianL\D SE\D Browns\D noseason.png}}}{Figure 30}\\
...
\subfloat{\includegraphics[clip,trim={0 0.7cm 0cm 1.56cm},width=0.43\textwidth]{\e max95\D SE\D Browns\D noseason.pdf}}}{Figure 31}\\
...
\begin{figure}
\centering
    \pdftooltip{\includegraphics[width=.6\textwidth]{\e LobPredatorsbiomass.png}}{Figure 32}\\
...
\begin{figure}
  ...
  \pdftooltip{  \includegraphics[width=.5\textwidth]{\e lfa41DFOTemp.png}
    \includegraphics[width=.5\textwidth]{\e lfa41NEFSCSpringTemps.png}}{Figure 33}\\
...
\begin{figure}
    ...
    \pdftooltip{\includegraphics[width=1\textwidth]{\e habitatAssociationsDFOsummerrestratified.pdf}}{Figure 34}
...
\begin{figure}
   ...
   \pdftooltip{ \includegraphics[width=1\textwidth]{\e habitatAssociationsNEFSCspringrestratified.pdf}}{Figure 35}
...
\begin{figure}
    ...
    \pdftooltip{\includegraphics[width=1\textwidth]{\e habitatAssociationsNEFSCfallrestratified.pdf}}{Figure 36}
...
\begin{figure}
    ...
    \pdftooltip{\includegraphics[width=1\textwidth]{\e habitatAssociationsgeorges.pdf}}{Figure 37}
...
\centering
   ...
   \pdftooltip{ \subfloat{\includegraphics[clip,trim={0 3cm 0cm 3.5cm},width=.6\textwidth]{\e DepthSurface.png}}
    \subfloat{\includegraphics[clip,trim={0 3cm 0cm 3.5cm},width=.6\textwidth]{\e SlopeSurface.png}}}{Figure 38}\\
...
\centering
   \pdftooltip{ \subfloat{\includegraphics[clip,trim={0 3cm 0cm 3.5cm},width=.33\textwidth]{\e temperature1970.png}}
    ...
    \subfloat{\includegraphics[clip,trim={0 3cm 0cm 3.5cm},width=.33\textwidth]{\e temperature1985.png}}}{Figure 39}\\
...
\begin{figure}
   ...
   \pdftooltip{ \includegraphics[width=1\textwidth]{\e brtinfluenceplots.png}}{Figure 40}
...
\centering
  ...
  \pdftooltip{  \subfloat{\includegraphics[clip,trim={0 1cm 0cm 1.5cm},width=.45\textwidth]{\e brtTime.png}}
    ...
    \subfloat{\includegraphics[clip,trim={0 1cm 0cm 1.5cm},width=.45\textwidth]{\e brtDepth.png}}}{Figure 41}\\
...
\centering
    ...
    \subfloat{\includegraphics[clip,trim={0 1.5cm 0cm 1.5cm},width=.33\textwidth]{\e trial\D continuousTimeboostedRegTree1985.png}}}{Figure 42}\\
...
\begin{figure}
   ...
   \pdftooltip{ \includegraphics[width=1\textwidth]{\e ProportionSuitableLobsterHabitat35.png}}{Figure 43}
...
\begin{figure}
   ...
   \pdftooltip{ \includegraphics[width=1\textwidth]{\e AMO.png}}{Figure 44}
...
\begin{figure}
  ...
  \pdftooltip{  \includegraphics[width=1\textwidth]{\e CPUE.png}}{Figure 45}
...
\begin{figure}
    ...
    \pdftooltip{\includegraphics[width=1\textwidth]{\e giniFootprintCPUE.png}}{Figure 46}
...
\begin{figure}
   ...
   \pdftooltip{ \includegraphics[width=0.5\textwidth]{\e indicators\D PC1.png}
    \includegraphics[width=0.5\textwidth]{\e indicators\D PC2.png}}{Figure 47}
...
\begin{figure}
   ...
   \pdftooltip{ \includegraphics[width=0.5\textwidth]{\e indicators\D ReducedIndicators\D PC1.png}
    \includegraphics[width=0.5\textwidth]{\e indicators\D ReducedIndicators\D PC2.png}}{Figure 48}
...
\begin{figure}
    ...
    \pdftooltip{\includegraphics[width=1\textwidth]{\e indicators\D anomalies.png}}{Figure 49}
...
\begin{figure}
    ...
    \pdftooltip{\includegraphics[width=1\textwidth]{\e indicators\D ReducedIndicators\D anomalies.png}}{Figure 50}
...
\begin{figure}
\centering
   \pdftooltip{ \includegraphics[width=.8\textwidth]{\e HCRExample.png}}{Figure 51}
...
\begin{figure}
\centering
        \pdftooltip{\subfloat{\includegraphics[width=0.85\textwidth]{\spm SurveyIndicesModeledB.png}}}{Figure 52}
...
\begin{figure}
\centering
        \pdftooltip{\subfloat{\includegraphics[clip,trim={0 1.cm 0.3cm 2.1cm},width=0.37\textwidth]{\spm priorposteriorr.png}}
        \subfloat{\includegraphics[clip,trim={0 1.cm 0.3cm 2.1cm},width=0.37\textwidth]{\spm priorposteriorK.png}}
        \subfloat{\includegraphics[clip,trim={0 1.cm 0.3cm 2.1cm},width=0.37\textwidth]{\spm priorposteriorq1.png}}}{Figure 53}\\
...
\begin{figure}
\centering
       \pdftooltip{ \subfloat{\includegraphics[clip,trim={0 1cm 0.3cm 2.1cm},width=0.37\textwidth]{\spm priorposteriorsdp.png}}
        \subfloat{\includegraphics[clip,trim={0 1cm 0.3cm 2.1cm},width=0.37\textwidth]{\spm priorposteriorsd\D oa.png}}
        \subfloat{\includegraphics[clip,trim={0 1cm 0.3cm 2.1cm},width=0.37\textwidth]{\spm priorposteriorsd\D ob.png}}}{Figure 54}\\
...
\begin{figure}
\centering
\pdftooltip{\includegraphics[width=0.85\textwidth]{\spm CarringCapacityPriorBiomasstoKratio.png}}{Figure 55}
...
\begin{figure}
\centering
\pdftooltip{ \subfloat{\includegraphics[clip,trim={0 0.7cm 0.3cm 1.56cm},width=0.33\textwidth]{\spm HCRKsens69.png}}
 \subfloat{\includegraphics[clip,trim={0 0.7cm 0.3cm 1.56cm},width=0.33\textwidth]{\spm HCRKsens104.png}}
 \subfloat{\includegraphics[clip,trim={0 0.7cm 0.3cm 1.56cm},width=0.33\textwidth]{\spm HCRKsens139.png}}}{Figure 56}\\
...
\begin{figure}
\centering
       \pdftooltip{  \subfloat{\includegraphics[width=0.65\textwidth]{\e BCPDFORefpointsNewArea.png}}
        \subfloat{\includegraphics[width=0.7\textwidth]{\e DFORefpointsNewArea.png}}}{Figure 57}
...
\begin{figure}
\centering
       \pdftooltip{ \subfloat{\includegraphics[width=0.7\textwidth]{\e relFDFOSurvey.png}}}{Figure 58}
...
\begin{figure}
\centering
       \pdftooltip{  \subfloat{\includegraphics[width=0.45\textwidth]{\e HCRLongTermDataDFOSurvey.png}}
        \subfloat{\includegraphics[width=0.45\textwidth]{\e HCRDataDFOSurvey.png}}}{Figure 59}\\
...
\begin{figure}
\centering
         \pdftooltip{\subfloat{\includegraphics[width=0.65\textwidth]{\e BCPSpringRefpointsNewArea.png}}
        \subfloat{\includegraphics[width=0.7\textwidth]{\e SpringRefpointsNewArea.png}}}{Figure 60}
...
\begin{figure}
\centering
        \pdftooltip{\subfloat{\includegraphics[width=0.7\textwidth]{\e relFSpringSurvey.png}}}{Figure 61}
...
\begin{figure}
\centering
         \pdftooltip{\subfloat{\includegraphics[width=0.45\textwidth]{\e HCRLongTermDataSpringSurvey.png}}
        \subfloat{\includegraphics[width=0.45\textwidth]{\e HCRDataSpringSurvey.png}}}{Figure 62}\\
...
\begin{figure}
\centering
         \pdftooltip{\subfloat{\includegraphics[width=0.65\textwidth]{\e BCPAutumnRefpointsNewArea.png}}
        \subfloat{\includegraphics[width=0.7\textwidth]{\e AutumnRefpointsNewArea.png}}}{Figure 63}
...
\begin{figure}
\centering
        \pdftooltip{\subfloat{\includegraphics[width=0.7\textwidth]{\e relFAutumnSurvey.png}}}{Figure 64}
...
\begin{figure}
\centering
        \pdftooltip{ \subfloat{\includegraphics[width=0.45\textwidth]{\e HCRLongTermDataAutumnSurvey.png}}
        \subfloat{\includegraphics[width=0.45\textwidth]{\e HCRDataAutumnSurvey.png}}}{Figure 65}\\
...
\begin{figure}
\centering
         \pdftooltip{\subfloat{\includegraphics[width=0.65\textwidth]{\e BCPGeorgesRefpointsNewArea.png}}
        \subfloat{\includegraphics[width=0.7\textwidth]{\e GeorgesRefpointsNewArea.png}}}{Figure 66}
...
\begin{figure}
\centering
        \pdftooltip{\subfloat{\includegraphics[width=0.7\textwidth]{\e relFGeorgesSurvey.png}}}{Figure 67}
...
\begin{figure}
\centering
         \pdftooltip{\subfloat{\includegraphics[width=0.45\textwidth]{\e HCRLongTermDataGeorgesSurvey.png}}
        \subfloat{\includegraphics[width=0.45\textwidth]{\e HCRDataGeorgesSurvey.png}}}{Figure 68}\\
...
\centering
    \pdftooltip{\subfloat{\includegraphics[width=0.7\textwidth]{\e RefsRepPotDFO.png}}}{Figure 69}
...
\begin{figure}
\centering
        \pdftooltip{\subfloat{\includegraphics[width=0.65\textwidth]{\e BCPRepPotNEFSCSpring.png}}
        \subfloat{\includegraphics[width=0.7\textwidth]{\e RefsRepPotNEFSCSpring.png}}}{Figure 70}
...
\begin{figure}
\centering
       \pdftooltip{ \subfloat{\includegraphics[width=0.65\textwidth]{\e BCPRepPotNEFSCAutumn.png}}
        \subfloat{\includegraphics[width=0.7\textwidth]{\e RefsRepPotNEFSCAutumn.png}}}{Figure 71}
...
\centering
   \pdftooltip{ \subfloat{\includegraphics[width=0.7\textwidth]{\e RefsRepPotGeorges.png}}}{Figure 72}
