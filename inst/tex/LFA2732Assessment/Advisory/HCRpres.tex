...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AmalesBase.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AfemalesBase.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AberriedBase.png}
        \end{center}
    \end{figure}
\end{frame}
...
%\begin{figure}
%        \begin{center}
%            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AremovalsBase.png}
%        \end{center}
%    \end{figure}
%\end{frame}
%
...
%\begin{figure}
%        \begin{center}
%            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AmoltsBase.png}
%        \end{center}
%    \end{figure}
%\end{frame}
%
...
%\begin{figure}
%        \begin{center}
%            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AeggsBase.png}
%        \end{center}
%    \end{figure}
%\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AmalesLS70.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AmalesLS72\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AmalesLS75.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AmalesLS77\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AmalesLS80.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AmalesLS85.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AmalesLS87\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AmalesLS90.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AfemalesLS70.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AfemalesLS72\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AfemalesLS75.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AfemalesLS77\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AfemalesLS80.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AfemalesLS85.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AfemalesLS87\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AfemalesLS90.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AberriedLS70.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AberriedLS72\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AberriedLS75.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AberriedLS77\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AberriedLS80.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AberriedLS85.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AberriedLS87\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC31AberriedLS90.png}
        \end{center}
    \end{figure}
\end{frame}
