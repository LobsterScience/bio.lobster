...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29malesBase.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29malesLS85.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29malesLS87\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29malesLS90.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29femalesBase.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29femalesLS85.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29femalesLS87\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29femalesLS90.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29berriedBase.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29berriedLS85.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29berriedLS87\D 5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29berriedLS90.png}
        \end{center}
    \end{figure}
\end{frame}
...
%%%%%%%%%%%% LFA 29 Season Adjust males %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}
\frametitle{Simulation Results}
LFA 29 - Season Adjust 100 \%
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29malesBase.png}
        \end{center}
...
\begin{frame}
\frametitle{Simulation Results}
LFA 29 - Season Adjust 90 \%
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29malesSS9.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}
\frametitle{Simulation Results}
LFA 29 - Season Adjust 80 \%
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29malesSS8.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}
\frametitle{Simulation Results}
LFA 29 - Season Adjust 70 \%
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29malesSS7.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}
\frametitle{Simulation Results}
LFA 29 - Season Adjust 60 \%
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29malesSS6.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}
\frametitle{Simulation Results}
LFA 29 - Season Adjust 50 \%
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29malesSS5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29femalesSS9.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29femalesSS8.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29femalesSS7.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29femalesSS6.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29femalesSS5.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29berriedSS9.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29berriedSS8.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29berriedSS7.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29berriedSS6.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 2cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh sim/LC29berriedSS5.png}
        \end{center}
    \end{figure}
\end{frame}
