...
%%%% modify \e to point to your figures directory
...
\begin{figure}
        \centering
    \pdftooltip{
                \subfloat{\includegraphics[clip,trim={1cm 2.1cm 1cm 2.1cm},width=0.5\textwidth]{\e Brad/ITQsurveyMap.pdf}}}
                \subfloat{\includegraphics[clip,trim={1cm 2.1cm 1cm 2.1cm},width=0.5\textwidth]{\e Brad/ILTSsurveyMap.pdf}}\\
                
         \caption{Survey design for the ITQ survey (left) and ILTS survey (right). Red points indicate stations conducted in 2000 for the ITQ and 2018 for the ILTS.}
        \end{figure}
...
\begin{figure}
        \centering
    \pdftooltip{
                \subfloat{\includegraphics[clip,trim={1cm 2.1cm 1cm 1.8cm},width=0.5\textwidth]{\e Brad/ScallopSurveyMap1.pdf}}}
                \subfloat{\includegraphics[clip,trim={1cm 2.1cm 1cm 1.8cm},width=0.5\textwidth]{\e Brad/ScallopSurveyMap2.pdf}}\\
                
         \caption{Areas covered by the scallop survey. Left panel shows the month in which each survey is generally conducted. Right panel shows the tows conducted between 2009-2018.}
...
% Carapace Length Frequencies Sea samples
   ...
   \begin{figure}
    \centering
        \pdftooltip{
        \includegraphics[width=1\textwidth]{\e Brad/CLFSeaSampling34b.pdf}}{Figure 10}
    ...
    \centering
        \pdftooltip{
        \includegraphics[width=1\textwidth]{\e Brad/CLFSeaSampling35a.pdf}}{Figure 11}
   ...
   \begin{figure}
    \centering
        \pdftooltip{
        \includegraphics[width=1\textwidth]{\e Brad/CLFSeaSampling35b.pdf}}{Figure 12}
   ...
   \begin{figure}
    \centering
        \pdftooltip{
        \includegraphics[width=1\textwidth]{\e Brad/CLFSeaSampling36a.pdf}}{Figure 13}
   ...
   \begin{figure}
    \centering
        \pdftooltip{
        \includegraphics[width=1\textwidth]{\e Brad/CLFSeaSampling38a.pdf}}{Figure 14}
