...
\newcommand{\ebh}{/backup/bio_data/bio.lobster/figures/LFA2733Framework2018/} %change this to set figure directory
...
\end{landscape}
   ...
   \begin{figure}
    \centering
        ...
        \includegraphics[width=1\textwidth]{\ebh Landings.pdf}
...
\begin{figure}
        \centering
         \pdftooltip{\subfloat{\includegraphics[clip,trim={0 1.1cm 0.3cm 1.1cm},width=0.48\textwidth]{\e AtSeaIndictors/CombinedDataProportion\D Mated27.png}}
                     ...
                     \subfloat{\includegraphics[clip,trim={0 1.1cm 0.3cm 1.1cm},width=0.48\textwidth]{\e AtSeaIndictors/CombinedDataProportion\D Mated30.png}}
                    
                    \caption{Time series of the proportion mature lobster in the landings from at sea samples, and /or  port samples. }
        \end{figure}
...
\begin{figure}
        \centering
         \pdftooltip{\subfloat{\includegraphics[clip,trim={0 1.1cm 0.3cm 1.1cm},width=0.48\textwidth]{\e AtSeaIndictors/CombinedDataProportion\D Mated31A.png}}
                     ...
                     \subfloat{\includegraphics[clip,trim={0 1.1cm 0.3cm 1.1cm},width=0.48\textwidth]{\e AtSeaIndictors/CombinedDataProportion\D Mated33.png}}
                    
                    \caption{Time series of the proportion mature lobster in the landings at sea samples, and /or  port samples.}
        \end{figure}
