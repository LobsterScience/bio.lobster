...
#		print(i)
	...
	for(j in 1:length(h)) {
			...
			fn = paste(strsplit(strsplit(a[i],"/")[[1]][grep("Length",strsplit(a[i],"/")[[1]])],"\\.")[[1]][1],y,'pdf',sep=".")
            nn = sum(g$ObsLobs)
			...
			fn = paste('max95',strsplit(strsplit(a[i],"/")[[1]][grep("Length",strsplit(a[i],"/")[[1]])],"\\.")[[1]][1],'pdf',sep=".")
            nn = sum(g$ObsLobs)
            pdf(file.path(project.figuredirectory('bio.lobster'),fn))
			...
			fn = paste('shannon',strsplit(strsplit(a[i],"/")[[1]][grep("Length",strsplit(a[i],"/")[[1]])],"\\.")[[1]][1],'pdf',sep=".")
            nn = sum(g$ObsLobs)
...
#			print(median(out$medL))
			save(out,file=file.path(fp,paste('medianL',strsplit(strsplit(a[i],"/")[[1]][grep("Length",strsplit(a[i],"/")[[1]])],"\\.")[[1]][1],'rdata',sep=".")))
			write.csv(out,file=file.path(fp,'indicators',paste('medianL',strsplit(strsplit(a[i],"/")[[1]][grep("Length",strsplit(a[i],"/")[[1]])],"\\.")[[1]][1],'csv',sep=".")))
				p=list()
                              ...
                              p$file.name = paste('medianL',strsplit(strsplit(a[i],"/")[[1]][grep("Length",strsplit(a[i],"/")[[1]])],"\\.")[[1]][1],'png',sep=".")
    		                  print(p$file.name)
...
for(i in 1:length(a)) {
	...
	for(j in 1:length(h)) {
			...
			fn = paste(strsplit(strsplit(a[i],"/")[[1]][grep("Length",strsplit(a[i],"/")[[1]])],"\\.")[[1]][1],min(y),max(y),'pdf',sep=".")
            nn = sum(g$ObsLobs)
            pdf(file.path(project.figuredirectory('bio.lobster'),fn))
