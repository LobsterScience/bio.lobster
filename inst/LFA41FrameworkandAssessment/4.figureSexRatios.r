...
la()
      ...
      a = c(file.path(project.datadirectory('bio.lobster'),'analysis','sexLFA41baseSummerRV.rdata  '),
		 file.path(project.datadirectory('bio.lobster'),'analysis','sexLFA41polygonSummerRV.rdata  ')	,
         ...
         file.path(project.datadirectory('bio.lobster'),'analysis','sexLFA41NEFSCfalladjrestratified.rdata  ')
		 ,
...
#Just >95mm
        ...
        a = c(file.path(project.datadirectory('bio.lobster'),'analysis','maturesexLFA41baseSummerRV.rdata  '),
		 file.path(project.datadirectory('bio.lobster'),'analysis','maturesexLFA41polygonSummerRV.rdata  ')	,
         ...
         file.path(project.datadirectory('bio.lobster'),'analysis','maturesexLFA41NEFSCfalladjrestratified.rdata  ')
		 ,
...
#Just <95mm
     ...
     file.path(project.datadirectory('bio.lobster'),'analysis','immaturesexLFA41polygonSummerRV.rdata  ') ,
         ...
         file.path(project.datadirectory('bio.lobster'),'analysis','immaturesexLFA41NEFSCfalladjrestratified.rdata  ')
     ,
