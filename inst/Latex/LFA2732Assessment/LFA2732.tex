...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh MapLFA27.pdf}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh CatchRateRefs27.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh ExploitationRefs27.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh FisheryPlot27.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh FSRSRecruitCatchRate27.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA27\D PC1.png}\\
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA27\D PC2.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebi OrdinationLFA27\D anomalies.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh MapLFA28.pdf}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh CatchRateRefs28.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh FisheryPlot28.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh MapLFA29.pdf}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh CatchRateRefs29.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh ExploitationRefs29.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh FisheryPlot29.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh FSRSRecruitCatchRate29.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA29\D PC1.png}\\
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA29\D PC2.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebi OrdinationLFA29\D anomalies.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA30\D PC1.png}\\
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA30\D PC2.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebi OrdinationLFA30\D anomalies.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA31A\D PC1.png}\\
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA31A\D PC2.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebi OrdinationLFA31A\D anomalies.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh MapLFA31B.pdf}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh CatchRateRefs31B.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh ExploitationRefs31B.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh FisheryPlot31B.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh FSRSRecruitCatchRate31B.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA31B\D PC1.png}\\
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA31B\D PC2.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebi OrdinationLFA31B\D anomalies.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh MapLFA32.pdf}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh CatchRateRefs32.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh ExploitationRefs32.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh FisheryPlot32.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh FSRSRecruitCatchRate32.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA32\D PC1.png}\\
            \includegraphics[clip,trim={0 0 1 0cm},width=\textwidth,height=0.4\textheight,keepaspectratio]{\ebi OrdinationLFA32\D PC2.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebi OrdinationLFA32\D anomalies.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh PhasePlot27.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh PhasePlot29.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh PhasePlot31B.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{figure}
        \begin{center}
            \includegraphics[clip,trim={0 0 0 0cm},width=\textwidth,height=0.8\textheight,keepaspectratio]{\ebh PhasePlot32.png}
        \end{center}
    \end{figure}
\end{frame}
