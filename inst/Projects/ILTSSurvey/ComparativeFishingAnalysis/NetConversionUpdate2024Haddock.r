...
v = ILTS_ITQ_All_Data(species=11,redo_base_data =F,return_base_data = T,biomass=T, )
v = subset(v,SPECCD_ID==11)
...
saveRDS(sou,file=file.path(project.datadirectory('bio.lobster'),'data','survey','summarybootRhoNestBall_FINAL_Haddock.rds'))
