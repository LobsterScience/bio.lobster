...
fp = file.path(project.datadirectory('bio.lobster'),"analysis",'lfa41Update2021')
       ...
       for(i in 1:length(ff)) {
        ...
        p=list()
                                ...
                                p$file.name = paste('Fec',strsplit(strsplit(ff[i],"/")[[1]][grep("Length",strsplit(ff[i],"/")[[1]])],"\\.")[[1]][1],'png',sep=".")
      		                  print(p$file.name)
         ...
         fnn = file.path(fp,paste('Fec',strsplit(strsplit(ff[i],"/")[[1]][grep("Length",strsplit(ff[i],"/")[[1]])],"\\.")[[1]][1],'csv',sep="."))
