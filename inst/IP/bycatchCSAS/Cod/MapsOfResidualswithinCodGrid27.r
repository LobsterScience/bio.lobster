...
g = readRDS('results/codFullPred27.rds')
g$res = g$pred - g$CodWt
...
png('Figures/ModelOutput/codResiduals27-1-9.png',width=10,height=12,units='in',res=300)
ggLobsterMap('27',bathy=T,attrData = x,legLab='Mean Residual',addLFALabels = F,scaleTrans = 'identity' ,brks=ux)
dev.off()
