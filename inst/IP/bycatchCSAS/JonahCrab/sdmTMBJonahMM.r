...
saveRDS(list(fit,g),file='JonahsdmTMBFull.rds')
...
saveRDS(list(fit1,g1),file='JonahsdmTMBSpace.rds')
...
saveRDS(list(fit2,g2),file='JonahsdmTMBDepth.rds')
...
savePlot('Figures/ModelOutput/JonahTrainTestDepthSpaceTime.png')
...
geom_histogram() + facet_wrap(~tt) + xlab('Residuals')
savePlot('Figures/ModelOutput/JonahTrainTestDepth.png')
...
geom_histogram() + facet_wrap(~tt) + xlab('Residuals')
savePlot('Figures/ModelOutput/JonahTrainTestDepthSpace.png')
