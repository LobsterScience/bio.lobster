...
g = readRDS('results/lobsterFullPred27.rds')
...
png('Figures/ModelOutput/LobsterResiduals27-1-9.png',width=10,height=12,units='in',res=300)
ggLobsterMap('27',bathy=T,attrData = subset(x,LFA==27& WOS %in% 1:9),fw='WOS',legLab='Mean Residual',addLFALabels = F,scaleTrans = 'identity' ,brks=ux)
dev.off()
