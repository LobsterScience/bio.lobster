...
g = readRDS('results/ModelOutput/lobstersdmTMBPred.rds')
g$res = g$pred - g$LegalWt
...
png('Figures/ModelOutput/LobsterResiduals33-1-12.png',width=10,height=12,units='in',res=300)
...
png('Figures/ModelOutput/LobsterResiduals33-13-24.png',width=10,height=12,units='in',res=300)
...
png('Figures/ModelOutput/LobsterResiduals34-1-12.png',width=10,height=12,units='in',res=300)
...
png('Figures/ModelOutput/LobsterResiduals34-13-24.png',width=10,height=12,units='in',res=300)
...
png('Figures/ModelOutput/LobsterResiduals35-1-10.png',width=10,height=12,units='in',res=300)
...
png('Figures/ModelOutput/LobsterResiduals35-21-31.png',width=10,height=12,units='in',res=300)
...
png('Figures/ModelOutput/LobsterResiduals35-32-40.png',width=10,height=12,units='in',res=300)
