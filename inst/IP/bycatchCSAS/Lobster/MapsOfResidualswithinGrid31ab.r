...
g = readRDS('results/ModelOutput/lobsterFullPred31ab.rds')
...
gP = aggregate(res~LFA+GRIDNUM+SYEAR,data=g,FUN=mean)
...
png('Figures/ModelOutput/LobsterResiduals31ab.png',width=10,height=12,units='in',res=300)
ggLobsterMap('ENS',bathy=T,attrData = x ,fw='SYEAR',legLab='Mean Residual',addLFALabels = F,scaleTrans = 'identity' ,brks=ux)
dev.off()
