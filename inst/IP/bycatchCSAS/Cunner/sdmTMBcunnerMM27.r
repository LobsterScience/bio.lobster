...
savePlot('Figures/ModelOutput/CunnerTrainTestDepthSpaceTime27.png')
...
geom_histogram() + facet_wrap(~tt) + xlab('Residuals')
savePlot('Figures/ModelOutput/CunnerTrainTestDepth27.png')
...
geom_histogram() + facet_wrap(~tt) + xlab('Residuals')
savePlot('Figures/ModelOutput/CunnerTrainTestDepthSpace27.png')
