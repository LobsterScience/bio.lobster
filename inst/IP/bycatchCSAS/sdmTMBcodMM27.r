...
savePlot('Figures/ModelOutput/CodTrainTestDepthSpaceTime27.png')
...
geom_histogram() + facet_wrap(~tt) + xlab('Residuals')
savePlot('Figures/ModelOutput/CodTrainTestDepth27.png')
...
geom_histogram() + facet_wrap(~tt) + xlab('Residuals')
savePlot('Figures/ModelOutput/CodTrainTestDepthSpace27.png')
