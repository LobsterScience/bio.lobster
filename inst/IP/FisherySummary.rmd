...
```{r, echo=FALSE,include=FALSE}
  ...
  a = lobster.db('seasonal.landings')
      ...
      sa = a %>% gather(key='LFA',value='Landings',-SYEAR)
      gg = ggplot(sa,aes(x=SYEAR,y=Landings/1000,fill=factor(SYEAR)))+geom_bar(stat='identity')+
      ...
      bar_colors <- ifelse(sa$SYEAR <max(sa$SYEAR), last_bar_color, "orange")
