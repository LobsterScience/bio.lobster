...
######## ENGLISH PLOT ###########
plot(l36$YEAR,l36$mu,xlab='Year',ylab=' Standardized CPUE (kg/TH)',type='p',pch=16,ylim=c(0,6),xlim=c(2005,2023))
...
######## FRENCH PLOT ###########
plot(l36$YEAR,l36$mu,xlab='Année',ylab='CPUE Standardisé (kg/casier levé)',type='p',pch=16,ylim=c(0,6),xlim=c(2005,2023))
running.median = with(rmed(l36$YEAR,l36$mu),data.frame(YEAR=yr,running.median=x))
l36=merge(l36,running.median,all=T)
lines(l36$YEAR,l36$running.median,col='blue',lty=1,lwd=3)
points(l36$YEAR[nrow(l36)],l36$mu[nrow(l36)], type='b', pch=24,bg='blue')
...
plot(g$SYEAR,g$LFA36,xlab='Année',ylab='Débarquements (t)',type='h',ylim=c(0,max(g$LFA36)*1.2),pch=15,col='grey',lwd=10,lend=3)
lines(g$SYEAR[nrow(g)],g$LFA36[nrow(g)],type='h',pch=21,col='steelblue4',lwd=10,lend=3)
par(new=T)
