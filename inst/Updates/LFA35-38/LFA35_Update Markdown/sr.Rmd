---
title: "Stock status update of lobster (* Homarus americanus *) in lobster fishing area 35 for 2021"
...
french_region: Région Pacifique
isbn: "ISBN-Here"
...
<!--chapter:end:tmp-tmp-01_context.Rmd-->
...
<!--chapter:end:tmp-tmp-02_background.Rmd-->
...
<!--chapter:end:tmp-tmp-03_analysis.Rmd-->
...
<!--chapter:end:tmp-tmp-04_conclusions.Rmd-->
...
<!--chapter:end:tmp-tmp-05_contributors.Rmd-->

\MakeApproval

<!--chapter:end:tmp-tmp-06_approval.Rmd-->
...
<!--chapter:end:tmp-tmp-07_bibliography.Rmd-->
