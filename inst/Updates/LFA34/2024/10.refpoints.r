...
aout = df
png(file.path(project.figuredirectory('bio.lobster'),"LFA34Update",'LFA34-DFOCommercialB.png'))
...
df$rMM = rmed(df$yr, df$rM)[[2]]
df$wMM = rmed(df$yr, df$w.Yst)[[2]]
png(file.path(project.figuredirectory('bio.lobster'),"LFA34Update",'LFA34-DFORelativeF.png'))
