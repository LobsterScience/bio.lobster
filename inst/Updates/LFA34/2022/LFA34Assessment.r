...
png(file=file.path(fpf1,'CPUELFA342022.png'),units='in',width=15,height=12,pointsize=18, res=300,type='cairo')
...
# Landings and Effort ############
	...
	# plot
	png(file=file.path(fpf1,'LandingsEffortLFA342022.png'),units='in',width=15,height=12,pointsize=18, res=300,type='cairo')
